...
public class ProductController {
	...
	public String sortByPriceFirstPage(@PathVariable("sortBy") String sortBy,@PathVariable("sortDir") String sortDir, Model model) {
		return sortByPrice(sortBy, sortDir,1, model);
	}
	
	@GetMapping("/sort/{sortBy}/{sortDir}/{pNum}")
	public String sortByPrice(@PathVariable("sortBy") String sortBy,@PathVariable("sortDir") String sortDir, Integer pNum ,Model model) {
		if (pNum == null || pNum == 0)
			pNum = 1;
